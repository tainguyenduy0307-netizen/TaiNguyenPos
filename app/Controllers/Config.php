...
class Config extends Secure_Controller
{
    ...
    public function postSaveReceipt(): ResponseInterface
    {
        $batch_save_data = [
            ...
            'receipt_company'               => $this->request->getPost('receipt_company'),
            'receipt_address'               => $this->request->getPost('receipt_address'),
            'receipt_phone'                 => $this->request->getPost('receipt_phone'),
            'receipt_phone_label'           => $this->request->getPost('receipt_phone_label'),
            'receipt_facebook'              => $this->request->getPost('receipt_facebook'),
            'receipt_website'               => $this->request->getPost('receipt_website', FILTER_SANITIZE_URL),
            'receipt_email'                 => strtolower($this->request->getPost('receipt_email', FILTER_SANITIZE_EMAIL)),
            'receipt_title'                 => $this->request->getPost('receipt_title'),
            'receipt_opening_hours'         => $this->request->getPost('receipt_opening_hours'),
            'receipt_exchange_policy'       => $this->request->getPost('receipt_exchange_policy'),
            'receipt_thank_you'             => $this->request->getPost('receipt_thank_you'),
            'receipt_show_address'          => $this->request->getPost('receipt_show_address') != null,
            'receipt_show_phone'            => $this->request->getPost('receipt_show_phone') != null,
            'receipt_show_facebook'         => $this->request->getPost('receipt_show_facebook') != null,
            'receipt_show_website'          => $this->request->getPost('receipt_show_website') != null,
            'receipt_show_customer_phone'   => $this->request->getPost('receipt_show_customer_phone') != null,
            'receipt_show_service_fee'      => $this->request->getPost('receipt_show_service_fee') != null,
            'receipt_show_discount'         => $this->request->getPost('receipt_show_discount') != null,
            'receipt_show_tax'              => $this->request->getPost('receipt_show_tax') != null,
            'receipt_show_amount_tendered'  => $this->request->getPost('receipt_show_amount_tendered') != null,
            'receipt_show_change'           => $this->request->getPost('receipt_show_change') != null,
            'receipt_show_opening_hours'    => $this->request->getPost('receipt_show_opening_hours') != null,
            'receipt_show_exchange_policy'  => $this->request->getPost('receipt_show_exchange_policy') != null,
            'receipt_show_thank_you'        => $this->request->getPost('receipt_show_thank_you') != null,
