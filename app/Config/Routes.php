...
$routes->post('sales/applyDiscount', 'Sales::postApplyDiscount', ['filter' => 'csrf']);
$routes->post('sales/removeDiscount', 'Sales::postRemoveDiscount', ['filter' => 'csrf']);
$routes->post('sales/selectCustomer', 'Sales::postSelectCustomer');
$routes->post('sales/removeCustomer', 'Sales::postRemoveCustomer', ['filter' => 'csrf']);
