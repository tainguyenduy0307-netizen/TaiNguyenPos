...
return [
    ...
    "fixed_account_cannot_delete"  => "Fixed employee accounts cannot be deleted.",
    "fixed_accounts_only"          => "Only the fixed employee accounts can be used.",
    "fixed_username_locked"        => "Fixed employee usernames cannot be changed.",
    "language"                     => "Language",
    "login_info"                   => "Login",
    "manager"                      => "",
    "new"                          => "New Employee",
    ...
    "only_own_password_change"     => "You can only change your own password.",
    "password"                     => "Password",
