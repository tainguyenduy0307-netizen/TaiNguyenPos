...
return [
    ...
    "fixed_account_cannot_delete"  => "Không thể xóa tài khoản nhân viên cố định.",
    "fixed_accounts_only"          => "Chỉ được sử dụng các tài khoản nhân viên cố định.",
    "fixed_username_locked"        => "Không thể thay đổi tên đăng nhập của tài khoản nhân viên cố định.",
    "language"                     => "Ngôn ngữ",
    ...
    "only_own_password_change"     => "Bạn chỉ được đổi mật khẩu của chính mình.",
    "password"                     => "Mật khẩu",
